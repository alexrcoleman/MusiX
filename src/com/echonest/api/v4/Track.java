...
public class Track extends ENItem {
    ...
    public String getArtistID() throws EchoNestException {
        return getTopLevelItem("artist_id");
    }
    private Artist cachedArtist;
    public Artist getArtist() throws EchoNestException {
    	if(cachedArtist == null && getArtistID() != null && !getArtistID().isEmpty())
    		cachedArtist = new Artist(en, getArtistID());
    	return cachedArtist;
    }
    ...
    public AnalysisStatus waitForAnalysis(long timeoutMillis) throws EchoNestException {
    	return waitForAnalysis(timeoutMillis, 250);
    }
    /**
     ...
     */
    public AnalysisStatus waitForAnalysis(long timeoutMillis, long checkInterval)
            throws EchoNestException {
